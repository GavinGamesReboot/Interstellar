...
if (nav) {
  var html = `
    ...
    <div class="fixed-nav-bar-right">
      <a class="navbar-link" href="/./g"><i class="fa-solid fa-gamepad navbar-icon"></i><xn>Ma</xn><xn>il</xn></a>
      <a class="navbar-link" href="/./ap"><i class="fa-solid fa-phone navbar-icon"></i><xn>Calend</xn><xn>ar</xn></a>
